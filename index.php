	...
	<div id="main">
    	...
    	<a title="<?= $title['text']; ?>" href="index.php">
        	...
        	<div id="ms">
             	<div id="lf" style="float:left;">
					...
					foreach($mains as $main):?>
						...
						<div class='mainmu cent'>
							...
							<div class="mw">
								<?php 
									if($Menu->count(['main_id'=>$main['main_id']])>0){
										$subs=$Menu->all(['main_id'=>$main['main_id']]);
										foreach($subs as $sub):
										?>
										<!---->
										<div  class='mainmu2'>
                	...
                	<div style="width:89%; height:480px;" class="dbor">
						...
						?>&emsp;
							...
							<div class="im cent" id="ssaa<?= $idx; ?>" >
								<img src="upload/<?= $img['img']; ?>" alt="" style="width:150px;height:103px;border:3px solid #1a73e8;margin:1px"></div>
						<?php endforeach;?>
            	...
            	<div style="width:1024px; left:0px; position:relative; background:#b6a5f3;margin-top:4px; height:83px; display:block;">
                	<span class="t" style="line-height:63px;"><?= $Bottom->find(1)['bottom'] ?></span>
                </div>
    </div>
